  ...
  return (
    <Modal isOpen={isOpen} onDismiss={onDismiss}>
      ...
      <ModalContent>
        <Split>
          <Box row>
            <FancyValue icon="🦁🚀" label="DEFI LION balance" value={getDisplayBalance(yamV3Balance)} />
          </Box>
          <Box row>
            <FancyValue
              icon={
        ...
        <Split>
          <Box row>
            <FancyValue icon="🎁" label="Vested DEFI LION (Delegator)" value={getDisplayBalance(vestedDelegatorRewardBalance)} />
          </Box>
          <Box row>
            <FancyValue icon="🦋" label="Vested DEFI LION (Migrated)" value={getDisplayBalance(vestedMigratedBalance)} />
          </Box>
        </Split>
        <Spacer />
      </ModalContent>
